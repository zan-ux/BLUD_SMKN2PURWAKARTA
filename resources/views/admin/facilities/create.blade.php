...
<div class="max-w-4xl mx-auto">
    <!-- Header -->
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-gray-900 mb-2">Tambah Fasilitas</h1>
        <p class="text-gray-500">Buat fasilitas baru untuk BLUD.</p>
    </div>
                ...
                <div>
                    ...
                    <div class="flex gap-4">
                        <label class="flex items-center gap-2">
                            <input type="radio" name="status" value="available" checked class="text-green-800 focus:ring-green-800">
                            <span class="text-sm text-gray-700">Tersedia</span>
                        </label>
                        <label class="flex items-center gap-2">
                            <input type="radio" name="status" value="maintenance" class="text-green-800 focus:ring-green-800">
                            <span class="text-sm text-gray-700">Perawatan</span>
                        </label>
                        <label class="flex items-center gap-2">
                            <input type="radio" name="status" value="unavailable" class="text-green-800 focus:ring-green-800">
